...
def readlines(fn):
    ...
    #return [line.strip('\n\r') for line in file]
    return [line.strip('\n\r').replace('/fast2/data', '/mnt/sdc') for line in file]
def build_lmdb_dataset_val10k(opt, log, transform=None):

    fn_10k = readlines(f"/mnt/sdb/gyr/I2SB/dataset/val_faster_imagefolder_10k_fn.txt")
    label_10k = readlines(f"/mnt/sdb/gyr/I2SB/dataset/val_faster_imagefolder_10k_label.txt")
